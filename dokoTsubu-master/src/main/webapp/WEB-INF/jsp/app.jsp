    ...
    <main class="content" id="main-content" tabindex="-1">
      <% if (request.getAttribute("flash") != null) { %>
        <div class="alert" style="display: flex; flex-direction: column; gap: 8px;">
          ...
          <% if (request.getAttribute("reissuedInviteUrl") != null) { %>
            <div class="no-print" style="display: flex; gap: 8px; align-items: center; max-width: 600px; width: 100%; margin-top: 4px;">
              <input type="text" readonly value="<%=e(request.getAttribute("reissuedInviteUrl"))%>" style="flex: 1; min-width: 0; padding: 6px 10px; font-size: 13px; font-family: monospace; border: 1px solid #c8d8d8; border-radius: 4px; background: #fdfdfd;" data-copy-target>
              <button type="button" class="button small" data-copy-button="<%=e(request.getAttribute("reissuedInviteUrl"))%>" style="padding: 6px 12px; font-size: 13px; font-weight: 700; white-space: nowrap; cursor: pointer;">コピー</button>
            </div>
          <% } %>
        </div>
      <% } %>
